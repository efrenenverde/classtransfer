CREATE database IF NOT EXISTS EmpresasABC;
USE EmpresasABC;
/*COMMENT 'Crear tabla Oficinas'*/
CREATE TABLE IF NOT EXISTS Oficinas (
codOficina CHAR(3) PRIMARY KEY,
nombre VARCHAR(30) NOT NULL,
region ENUM('Galicia','Asturias', 'Cantabria', 'Euzkadi', 'Navarra'),
...
retencionesIRPF decimal(4,2) NOT NULL,
retencionesSS decimal(4,2) NOT NULL,
CONSTRAINT FKEmpleOfic FOREIGN KEY (oficina) REFERENCES Oficinas 
(codOficina),
CONSTRAINT FKjefe FOREIGN KEY (codJefe) REFERENCES Empleados 
(codEmpleado)
)ENGINE = InnoDB;
...
codRepCliente CHAR(5) NOT NULL,
limiteCredito DOUBLE(7,2) NOT NULL,
CONSTRAINT FKRepEmpleados FOREIGN KEY (codRepCliente) REFERENCES Empleados (CodEmpleado))ENGINE = InnoDB;
...
CONSTRAINT FKPedClientes FOREIGN KEY (codCliente) 
REFERENCES Clientes (codCliente),
CONSTRAINT FKPedEmpleados FOREIGN KEY (codRepresentante) 
REFERENCES Empleados (codEmpleado))ENGINE = InnoDB;
...
precioVenta FLOAT(6,2) UNSIGNED NOT NULL,
CONSTRAINT PKLineasPedido PRIMARY KEY (codPedido, numLinea),
CONSTRAINT FKLinPedPed FOREIGN KEY (codPedido) 
REFERENCES Pedidos (codPedido),
CONSTRAINT FKLinPedPro FOREIGN KEY (fabricante, producto) 
REFERENCES Productos (idFabricante, idProducto)
)ENGINE = InnoDB;